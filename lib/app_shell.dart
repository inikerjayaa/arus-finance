...
class AppShell extends StatelessWidget {
  const AppShell({super.key, required this.controller, required this.database, required this.security});
  ...
  Widget build(BuildContext context) {
    ...
    return AppScope(
      ...
      child: AnimatedBuilder(
        ...
        appBar: AppBar(
          title: const Text('Arus'),
          centerTitle: false,
          actions: [
            IconButton(
              tooltip: 'Accounts',
              onPressed: () => Navigator.of(context).push(MaterialPageRoute(builder: (_) => AppScope(controller: controller, child: const AccountsScreen()))),
              icon: const Icon(Icons.account_balance_wallet_outlined),
            ),
            IconButton(
              tooltip: 'Pengaturan',
              onPressed: () => Navigator.of(context).push(MaterialPageRoute(builder: (_) => AppScope(
                controller: controller,
        ...
        body: Stack(children: [
          IndexedStack(
            index: switch (controller.navigationIndex) { 0 => 0, 1 => 1, 3 => 2, 4 => 3, _ => 0 },
            children: [pages[0]!, pages[1]!, pages[3]!, pages[4]!],
          ),
          if (controller.busy) const Positioned(left: 0, right: 0, top: 0, child: LinearProgressIndicator(minHeight: 2)),
              ...
              child: Semantics(
                ...
                child: Material(
                  ...
                  child: ListTile(
                    ...
                    title: Text(controller.errorMessage!, style: TextStyle(color: Theme.of(context).colorScheme.onErrorContainer)),
                    trailing: IconButton(
              ...
              child: Semantics(
                ...
                child: Material(
                  ...
                  child: ListTile(
                    ...
                    title: Text(controller.noticeMessage!, style: TextStyle(color: Theme.of(context).colorScheme.onSecondaryContainer)),
                    trailing: Row(
                      mainAxisSize: MainAxisSize.min,
                      children: [
                        IconButton(
                          tooltip: 'Muat ulang tampilan',
                          onPressed: controller.busy ? null : controller.retryPresentationRefresh,
        ...
        bottomNavigationBar: NavigationBar(
          ...
          destinations: const [
            ...
            NavigationDestination(icon: Icon(Icons.event_note_outlined), selectedIcon: Icon(Icons.event_note_rounded), label: 'Rencana'),
            NavigationDestination(icon: Icon(Icons.insights_outlined), selectedIcon: Icon(Icons.insights_rounded), label: 'Insight'),
          ],
        ),
      ),
      ),
