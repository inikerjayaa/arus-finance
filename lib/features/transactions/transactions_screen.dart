...
class _TransactionsScreenState extends State<TransactionsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final active =
        controller.transactionFilter.isActive ||
        controller.transactionQuery.isNotEmpty;
    return Column(
      children: [
        Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              TextField(
                ...
                onSubmitted: (value) =>
                    controller.refreshTransactions(query: value),
              ),
              if (active) ...[
            ...
            child: controller.transactions.isEmpty
                ...
                : ListView.separated(
                    ...
                    itemCount:
                        ...
                        (controller.hasMoreTransactions ? 1 : 0),
                        ...
                        return Padding(
                          ...
                          child: Center(
                            child: OutlinedButton.icon(
                              ...
                              label: Text(
                                controller.loadingMoreTransactions
                                    ? 'Memuat…'
  ...
  List<Widget> _filterChips(TransactionFilter f) {
    ...
    if (f.status != null)
      result.add(Chip(label: Text('Status: ${f.status!.name}')));
    ...
    if (f.startDate != null || f.endDate != null)
      result.add(Chip(label: Text(_dateRangeLabel(f))));
    if (f.minAmountMinor != null || f.maxAmountMinor != null)
      result.add(Chip(label: Text(_amountRangeLabel(f))));
    return result;
  }
  ...
  String _amountRangeLabel(TransactionFilter f) {
    final min = f.minAmountMinor == null
        ? '…'
        : Money.format(f.minAmountMinor!);
    final max = f.maxAmountMinor == null
        ? '…'
        : Money.format(f.maxAmountMinor!);
    return '$min – $max';
  }
  ...
  Future<void> _showFilters(BuildContext context) async {
    ...
    final minAmount = TextEditingController(
      text: filter.minAmountMinor?.toString() ?? '',
    );
    final maxAmount = TextEditingController(
      text: filter.maxAmountMinor?.toString() ?? '',
    );
    ...
    final result = await showModalBottomSheet<TransactionFilter>(
      ...
      builder: (sheetContext) => StatefulBuilder(
        builder: (context, setState) {
          final categories = filter.type == TransactionType.income
                  ...
                  DropdownButtonFormField<TransactionType?>(
                    ...
                    items: [
                      ...
                      ...TransactionType.values.map(
                        (v) => DropdownMenuItem<TransactionType?>(
                          value: v,
                  ...
                  DropdownButtonFormField<TransactionStatus?>(
                    ...
                    items: [
                      ...
                      ...TransactionStatus.values.map(
                        (v) => DropdownMenuItem<TransactionStatus?>(
                          value: v,
                          child: Text(v.name),
                        ),
                      ),
                      ...
                      Expanded(
                        child: OutlinedButton.icon(
                          ...
                          onPressed: () async {
                            ...
                            if (p != null)
                              setState(
                                () => filter = filter.copyWith(startDate: p),
                              );
                          },
                        ),
                      ),
                      ...
                      Expanded(
                        child: OutlinedButton.icon(
                          ...
                          onPressed: () async {
                            ...
                            if (p != null)
                              setState(
                                () => filter = filter.copyWith(endDate: p),
                              );
                          },
                        ),
                      ),
                    ...
                    onPressed: () {
                      ...
                      if (min != null && max != null && min > max) {
                        ScaffoldMessenger.of(context).showSnackBar(
                          const SnackBar(
                            content: Text(
                              'Nominal minimum tidak boleh lebih besar dari maksimum.',
                            ),
                          ),
                        );
                        return;
