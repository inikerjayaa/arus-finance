...
class _SettingsScreenState extends State<SettingsScreen> {
        ...
        children: [
            ...
            child: Column(
              children: [
                ...
                SwitchListTile(
                  ...
                  subtitle: Text(
                    _canBio == true
                        ? 'Gunakan fingerprint/Face ID setelah PIN aktif'
                ...
                if (_hasPin == true) ...[
                  ...
                  ListTile(
                    ...
                    title: const Text('Nonaktifkan app lock'),
          ...
          Card(
            child: ListTile(
              ...
              subtitle: const Text(
                'Tambah atau arsipkan kategori pemasukan/pengeluaran',
              ),
              trailing: const Icon(Icons.chevron_right),
              onTap: () {
            ...
            child: Column(
              children: [
                SwitchListTile(
                  ...
                  subtitle: const Text(
                    'Dijadwalkan di perangkat. Tidak memerlukan server atau akun.',
                  ),
                ...
                SwitchListTile(
                  ...
                  subtitle: const Text(
                    'Default dimatikan agar nominal/nama tidak tampil di lock screen.',
                  ),
          ...
          const SizedBox(height: 8),
          Text(
            'Arus tidak menyimpan salinan cloud. Buat backup terenkripsi secara berkala, terutama sebelum ganti HP atau menghapus aplikasi.',
            ...
            child: Column(
              children: [
                ListTile(
                  ...
                  subtitle: const Text(
                    'Ekspor transaksi yang dapat dibuka di Excel/Sheets',
                  ),
                ...
                ListTile(
                  ...
                  subtitle: const Text(
                    'Preview + validasi + import atomik dari format export Arus',
                  ),
                  trailing: const Icon(Icons.chevron_right),
                ...
                ListTile(
                  ...
                  subtitle: const Text('Portable backup dengan passphrase'),
                  trailing: const Icon(Icons.chevron_right),
                ...
                ListTile(
                  ...
                  subtitle: const Text('Restore atomic + integrity check'),
                  trailing: const Icon(Icons.chevron_right),
                ...
                ListTile(
                  ...
                  subtitle: const Text(
                    'Rollback terenkripsi ke generasi lokal terbaru',
                  ),
                  trailing: const Icon(Icons.chevron_right),
                ...
                ListTile(
                  ...
                  subtitle: const Text(
                    'Pemeriksaan lokal SQLite; tidak mengirim data ke mana pun',
                  ),
                  trailing: const Icon(Icons.chevron_right),
            ...
            child: Column(
              children: [
                ListTile(
                  ...
                  title: Text('Device-owned'),
                  subtitle: Text(
                    'Data keuangan utama disimpan di perangkat. Internet dan akun tidak diperlukan.',
                  ),
                ),
                Divider(height: 1),
                ListTile(
                  ...
                  title: Text('Tema'),
                  subtitle: Text('Mengikuti Light/Dark Mode perangkat.'),
                ),
              ],
            ),
          ),
          ...
          Card(
            child: ListTile(
              ...
              subtitle: const Text('Tidak dapat dibatalkan tanpa backup.'),
              onTap: () => _wipe(context),
            ),
          ),
        ],
        ...
        actions: [
          ...
          FilledButton(
            onPressed: () async {
              ...
              try {
                await widget.security.setPin(controller.text);
  ...
  Future<void> _restore(BuildContext context) async {
    ...
    final replace = await showDialog<bool>(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: const Text(
          'Restore akan mengganti seluruh data finansial yang sekarang ada di perangkat. Jika ragu, buat backup data aktif terlebih dahulu.',
        ),
        actions: [
          TextButton(
            onPressed: () => Navigator.pop(ctx, false),
    ...
    try {
      ...
      if (context.mounted)
        _snack(context, 'Restore gagal. Data lama tidak diubah. $e');
    }
  }
  ...
  Future<void> _restoreLocalRecovery(BuildContext context) async {
    ...
    try {
      ...
      _snack(
        context,
        'Titik pemulihan lokal berhasil diterapkan dan tervalidasi.',
      );
    } catch (e) {
  ...
  Future<void> _verifyIntegrity(BuildContext context) async {
    try {
      ...
      if (context.mounted)
        _snack(context, 'Database lokal sehat. Integrity check: OK.');
    } catch (e) {
  ...
  Future<void> _wipe(BuildContext context) async {
    final ok = await showDialog<bool>(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: const Text(
          'Account, transaksi, budget, bill, dan recurring lokal akan dihapus. Buat backup bila data masih dibutuhkan.',
        ),
        actions: [
          TextButton(
            onPressed: () => Navigator.pop(ctx, false),
    ...
    try {
      ...
      if (context.mounted) {
        _snack(
          context,
          'Penghapusan dibatalkan karena material recovery belum dapat dibersihkan: $e',
        );
      }
      return;
    }
    ...
    await _reloadRecovery();
    if (context.mounted)
      _snack(context, 'Data lokal dan material recovery lama sudah direset.');
  }
      ...
      builder: (ctx) => StatefulBuilder(
        builder: (context, setState) => AlertDialog(
          ...
          content: Column(
            ...
            children: [
              const Text(
                'Ketik HAPUS untuk mengonfirmasi bahwa seluruh data lokal dan material recovery akan direset.',
              ),
              const SizedBox(height: 12),
              TextField(
                controller: input,
                ...
                onChanged: (value) =>
                    setState(() => matches = value.trim() == 'HAPUS'),
                onSubmitted: (_) {
