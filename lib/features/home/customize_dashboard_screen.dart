...
class CustomizeDashboardScreen extends StatefulWidget {
  const CustomizeDashboardScreen({super.key, required this.service, required this.initial});
    ...
    return Scaffold(
      ...
      body: Column(children: [
        Padding(
          ...
          child: Text('Tampilkan hanya informasi yang penting untukmu. Tahan ikon drag untuk mengubah urutan.', style: Theme.of(context).textTheme.bodyMedium),
        ),
          ...
          itemBuilder: (context, index) {
            ...
            return Card(
              ...
              child: SwitchListTile(
                value: item.enabled,
                onChanged: (v) => setState(() => _items[index] = item.copyWith(enabled: v)),
                title: Text(item.label),
                secondary: ReorderableDragStartListener(index: index, child: const Icon(Icons.drag_indicator_rounded)),
              ),
            );
          },
        )),
